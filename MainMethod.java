...
public class MainMethod {
	...
	public static void print_Display(Laptop[] lap)
	{
		for(int i=0;i<lap.length;i++)
		{
			System.out.println("laptop "+i+" company           :"+lap[i].company);
			System.out.println("laptop "+i+" model             :"+lap[i].model);
			System.out.println("laptop "+i+" id                :"+lap[i].id);
			System.out.println("laptop "+i+" price             :"+lap[i].price);
			System.out.println("laptop "+i+" diplay height     :"+lap[i].height);
			System.out.println("laptop "+i+" display width     :"+lap[i].width);
			System.out.println("laptop "+i+" Warrenty Period   :"+lap[i].warrentyPeriod);
			System.out.println("laptop "+i+" ratings           :"+lap[i].ratings);
		}
	}
